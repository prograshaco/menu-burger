console.log('🔍 Probando creación de reseña en servidor SQLite...');

const reviewData = {
  userId: 'admin-test-001',
  userName: 'Usuario de Prueba SQLite',
  rating: 5,
  comment: 'Esta es una reseña de prueba para verificar la funcionalidad SQLite.',
  approved: false
};
