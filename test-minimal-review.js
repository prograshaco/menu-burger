console.log('🔍 Probando creación de reseña en servidor mínimo...');

const reviewData = {
  userId: 'admin-test-001',
  userName: 'Usuario de Prueba Mínimo',
  rating: 5,
  comment: 'Esta es una reseña de prueba para verificar el servidor mínimo.',
  approved: false
};
