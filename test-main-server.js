console.log('🔍 Probando creación de reseña en servidor principal...');

const reviewData = {
  userId: 'admin-test-001',
  userName: 'Usuario de Prueba Servidor Principal',
  rating: 5,
  comment: 'Esta es una reseña de prueba para verificar el servidor principal.',
  approved: false
};
...
try {
  const response = await fetch('http://localhost:3006/api/reviews', {
    method: 'POST',
    headers: {
